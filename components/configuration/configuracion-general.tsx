        ...
        <TabsContent value='plataforma'>
          <div className='grid gap-6 md:grid-cols-2'>
            <Card>
              ...
              <CardContent className='space-y-4'>
                ...
                <div className='space-y-2'>
                  ...
                  <Input
                    id='url-plataforma'
                    defaultValue='https://editorial-medica.com'
                  />
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className='space-y-4'>
                <div className='space-y-2'>
                  ...
                  <Input
                    id='smtp-servidor'
                    defaultValue='smtp.editorial-medica.com'
                  />
                </div>
                <div className='space-y-2'>
                ...
                <div className='space-y-2'>
                  ...
                  <Input
                    id='smtp-usuario'
                    defaultValue='no-reply@editorial-medica.com'
                  />
                </div>
                <div className='space-y-2'>
              ...
              <CardContent className='space-y-4'>
                <div className='flex items-center justify-between'>
                  <div className='space-y-0.5'>
                    <Label htmlFor='modo-mantenimiento'>
                      Modo mantenimiento
                    </Label>
                ...
                <div className='flex items-center justify-between'>
                  <div className='space-y-0.5'>
                    <Label htmlFor='notificaciones-email'>
            ...
            <Card>
              ...
              <CardContent className='space-y-4'>
                <div className='space-y-2'>
                  <Label htmlFor='max-tamano-archivo'>
                    Tamaño máximo de archivo (MB)
                  </Label>
                  <Input
                    id='max-tamano-archivo'
                    type='number'
                    defaultValue='10'
                  />
                </div>
                <div className='space-y-2'>
                  <Label htmlFor='formatos-permitidos'>
                    Formatos permitidos
                  </Label>
                  <Input
                    id='formatos-permitidos'
                    defaultValue='pdf,doc,docx,jpg,png'
                  />
                </div>
                <div className='space-y-2'>
                  <Label htmlFor='ruta-almacenamiento'>
                    Ruta de almacenamiento
                  </Label>
                  <Input
                    id='ruta-almacenamiento'
        ...
        <TabsContent value='contacto'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configura la información de contacto de la plataforma
              </CardDescription>
            </CardHeader>
            <CardContent className='space-y-4'>
              <div className='space-y-2'>
                ...
                <Input
                  id='email-contacto'
                  defaultValue='contacto@editorial-medica.com'
                />
              </div>
              <div className='space-y-2'>
        ...
        <TabsContent value='legal'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configura la información legal de la plataforma
              </CardDescription>
            </CardHeader>
            <CardContent className='space-y-4'>
              <div className='space-y-2'>
              ...
              <div className='space-y-2'>
                <Label htmlFor='registro-mercantil'>
              ...
              <div className='space-y-2'>
                <Label htmlFor='responsable-datos'>
                  Responsable de protección de datos
                </Label>
                <Input
                  id='responsable-datos'
                  defaultValue='protecciondatos@editorial-medica.com'
                />
              </div>
            </CardContent>
            <CardFooter>
          ...
          <Card>
            ...
            <CardContent className='space-y-4'>
              <div className='space-y-2'>
                ...
                <Input
                  id='facebook'
                  defaultValue='https://facebook.com/editorialmedica'
                />
              </div>
              <div className='space-y-2'>
                ...
                <Input
                  id='twitter'
                  defaultValue='https://twitter.com/editorialmedica'
                />
              </div>
              <div className='space-y-2'>
                ...
                <Input
                  id='instagram'
                  defaultValue='https://instagram.com/editorialmedica'
                />
              </div>
              <div className='space-y-2'>
                ...
                <Input
                  id='linkedin'
                  defaultValue='https://linkedin.com/company/editorialmedica'
                />
              </div>
              <div className='space-y-2'>
                ...
                <Input
                  id='youtube'
                  defaultValue='https://youtube.com/c/editorialmedica'
                />
              </div>
            </CardContent>
            <CardFooter>
