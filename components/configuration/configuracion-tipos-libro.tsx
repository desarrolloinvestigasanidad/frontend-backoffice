...
const tiposLibroEjemplo = [
  {
    ...
    caracteristicas: "Múltiples autores, revisión editorial, certificados por capítulo",
  },
  {
    id: 2,
    nombre: "Libro propio",
    descripcion: "Libro creado por un único autor o grupo de autores",
    caracteristicas: "Autor único o grupo definido, diseño personalizado, ISBN propio",
  },
]
    ...
    <div className="space-y-6">
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              ...
              <DialogDescription>Añade un nuevo tipo de libro al sistema.</DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input id="nombre-tipo" placeholder="Ej: Libro de edición" className="col-span-3" />
              </div>
              <div className="grid grid-cols-4 items-start gap-4">
                <Label htmlFor="descripcion-tipo" className="text-right pt-2">
                  Descripción
                </Label>
                <Textarea id="descripcion-tipo" placeholder="Descripción del tipo de libro" className="col-span-3" />
              </div>
              <div className="grid grid-cols-4 items-start gap-4">
                <Label htmlFor="caracteristicas-tipo" className="text-right pt-2">
                  Características
                </Label>
                <Textarea
      ...
      <div className="mt-8 p-4 border rounded-md bg-muted/30">
        ...
        <p className="text-sm text-muted-foreground">
          Según las especificaciones del sistema, solo habrá dos tipos de libro: Libro de edición y Libro propio. No
          habrá libro individual.
        </p>
      </div>
    </div>
  )
