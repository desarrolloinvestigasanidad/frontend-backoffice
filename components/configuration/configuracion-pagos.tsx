...
const metodosPagoEjemplo = [
  ...
  },
  {
    ...
    activo: false,
    comision: 0.5,
    descripcion: "Pago mediante Bizum",
  },
];
...
const preciosEjemplo = [
  ...
  {
    id: 2,
    concepto: "Libro personalizado (hasta 100 páginas)",
    precio: 1200,
    descripcion: "Precio base para libro personalizado",
  },
  {
    id: 3,
    concepto: "Página adicional libro personalizado",
    precio: 10,
    descripcion: "Precio por página adicional en libro personalizado",
  },
  {
    id: 4,
    concepto: "Diseño de portada personalizada",
    precio: 150,
    descripcion: "Diseño de portada personalizada",
  },
];
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
              ...
              <DialogContent className='sm:max-w-[425px]'>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Configura un nuevo método de pago para la plataforma.
                  </DialogDescription>
                </DialogHeader>
            ...
            <Dialog open={precioDialogOpen} onOpenChange={setPrecioDialogOpen}>
              ...
              <DialogContent className='sm:max-w-[425px]'>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Configura un nuevo precio para la plataforma.
                  </DialogDescription>
                </DialogHeader>
                <div className='grid gap-4 py-4'>
                  <div className='grid grid-cols-4 items-center gap-4'>
                    ...
                    <Input
                      id='concepto'
                      placeholder='Ej: Capítulo en libro'
                      className='col-span-3'
                    />
                  </div>
                  <div className='grid grid-cols-4 items-center gap-4'>
                ...
                <DialogFooter>
                  <Button
                    type='submit'
                    onClick={() => setPrecioDialogOpen(false)}>
                    Guardar
                  </Button>
                </DialogFooter>
              </DialogContent>
        ...
        <TabsContent value='metodos' className='mt-6'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configura los métodos de pago que estarán disponibles en la
                plataforma.
              </CardDescription>
            </CardHeader>
            <CardContent>
                      ...
                      <TableCell>
                        <div className='flex items-center space-x-2'>
                          <Switch
                            ...
                            onCheckedChange={() =>
                              handleToggleMetodoPago(metodo.id)
                            }
                          />
                          <span
                            className={
        ...
        <TabsContent value='precios' className='mt-6'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configura los precios de los diferentes servicios de la
                plataforma.
              </CardDescription>
            </CardHeader>
            <CardContent>
