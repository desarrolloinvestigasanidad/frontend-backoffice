...
// ... (resto de las importaciones y la definición de configSections se mantienen igual) ...
type ConfigSection = {
  id: string;
  title: string;
...
const configSections: ConfigSection[] = [
  ...
  },
  {
    ...
    icon: MapPinned,
    description: "Gestiona las comunidades.",
    component: <ConfiguracionComunidades />,
  },
  {
    id: "provincias",
    title: "Provincias",
    ...
    component: <ConfiguracionProvincias />,
  },
  {
    id: "estados-libro",
    title: "Estados de Libro",
    icon: BookCheck,
    description: "Ciclo de vida de un libro.",
    component: <ConfiguracionEstadosLibro />,
  },
  {
    id: "estados-capitulo",
    title: "Estados de Capítulo",
    icon: FileCheck2,
    description: "Ciclo de vida de un capítulo.",
    component: <ConfiguracionEstadosCapitulo />,
  },
  {
    id: "tipos-estudio",
  ...
  },
  {
    ...
    icon: Users2,
    description: "Roles o tipos de asociación.",
    component: <ConfiguracionTiposAsociacion />,
  },
  {
  ...
  return (
    <div className='container mx-auto py-8 px-4 md:px-6 relative'>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent
          className='fixed inset-0 z-[100] m-0 h-screen w-screen max-w-full overflow-hidden !rounded-none border-0 bg-gray-100 p-0 shadow-none outline-none dark:bg-gray-900 sm:!rounded-none md:!rounded-none lg:!rounded-none xl:!rounded-none !translate-x-0 !translate-y-0 !transform-none !top-0 !left-0 flex flex-col'
          // onInteractOutside={(e) => e.preventDefault()} // Descomentar si no quieres que se cierre al hacer clic fuera
        >
          {selectedConfig && (
            <>
              ...
              <div className='flex-grow overflow-y-auto'>
                {" "}
                {/* Contenedor con scroll para el componente */}
                <div className='p-6'>
                  {" "}
